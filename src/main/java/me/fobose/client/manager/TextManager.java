...
import me.fobose.client.features.gui.font.CustomFont;
...
public class TextManager extends Feature {
    ...
    public void init(boolean startup) {
        FontMod cFont = Fobose.moduleManager.getModuleByClass(FontMod.class);
        try {
    ...
    public float drawString(String text, float x, float y, int color, boolean shadow) {
        if (Fobose.moduleManager.isModuleEnabled(FontMod.class)) {
            if (shadow) {
