...
package me.fobose.client.features.gui.components;
...
import me.fobose.client.features.gui.components.items.buttons.Button;
...
extends Feature {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.open) {
            ...
            if (ClickGui.getInstance().outline.getValue().booleanValue()) {
                if (ClickGui.getInstance().rainbowRolling.getValue().booleanValue()) {
                    ...
                    GlStateManager.shadeModel((int)7425);
                    GL11.glBegin((int)2);
                    Color outlineColor = ClickGui.getInstance().colorSync.getValue() != false ? new Color(Colors.INSTANCE.getCurrentColorHex()) : new Color(Fobose.colorManager.getColorAsIntFullAlpha());
        ...
        Fobose.textManager.drawStringWithShadow(this.getName(), (float)this.x + 3.0f, (float)this.y - 4.0f - (float)PhobosGui.getClickGui().getTextOffset(), -1);
        if (this.open) {
