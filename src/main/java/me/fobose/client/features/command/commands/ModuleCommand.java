    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Fobose.moduleManager.getCategories()) {
                ...
                for (Module module : Fobose.moduleManager.getModulesByCategory(category)) {
        ...
        Module module = Fobose.moduleManager.getModuleByDisplayName(commands[0]);
        if (module == null) {
            module = Fobose.moduleManager.getModuleByName(commands[0]);
            if (module == null) {
