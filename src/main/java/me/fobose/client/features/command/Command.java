package me.fobose.client.features.command;
...
public abstract class Command extends Feature {
    ...
    public static void sendMessage(String message, boolean notification) {
        Command.sendSilentMessage(Fobose.commandManager.getClientMessage() + " " + "\u00a7r" + message);
        if (notification) {
            Fobose.notificationManager.addNotification(message, 3000L);
        }
    }
    ...
    public static String getCommandPrefix() {
        return Fobose.commandManager.getPrefix();
    }
