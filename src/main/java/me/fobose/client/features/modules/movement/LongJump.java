...
extends Module {
    ...
    public void onEnable() {
        ...
        if (Strafe.INSTANCE.isOn() && this.disableStrafe.getValue().booleanValue()) {
    ...
    public void onTickEvent(TickEvent.ClientTickEvent event) {
        ...
        if (Strafe.INSTANCE.isOn() && this.strafeOff.getValue().booleanValue()) {
            this.disable();
            return;
        }
        ...
        switch (this.mode.getValue()) {
            ...
            case DIRECT: {
                ...
                if (!LongJump.mc.player.collidedVertically) {
                    ...
                    if (LongJump.mc.gameSettings.keyBindForward.isPressed()) {
                        try {
