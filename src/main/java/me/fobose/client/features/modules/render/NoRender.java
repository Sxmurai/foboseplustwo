...
//                        NoRender.mc.fontRenderer.drawStringWithShadow(text, (float)i / this.scale.getValue() / 2.0f - (float)(NoRender.mc.fontRenderer.getStringWidth(text) / 2), (float)(j - 9), 0xFFFFFF);
//                    }
//                    GL11.glScaled((double)(1.0 / (double) this.scale.getValue()), (double)(1.0 / (double) this.scale.getValue()), (double)1.0);
