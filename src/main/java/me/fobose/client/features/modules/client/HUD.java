...
import me.fobose.client.features.modules.misc.ToolTips;
...
extends Module {
    ...
    public Setting<Integer> factor = this.register(new Setting<>("Factor", Integer.valueOf(1), Integer.valueOf(0), Integer.valueOf(20), v -> this.rainbow.getValue()));
    public Setting<Boolean> rolling = this.register(new Setting<>("Rolling", Boolean.valueOf(false), v -> this.rainbow.getValue()));
    public Setting<Boolean> staticRainbow = this.register(new Setting<>("Static", Boolean.valueOf(false), v -> this.rainbow.getValue()));
    public Setting<Integer> rainbowSpeed = this.register(new Setting<>("RSpeed", Integer.valueOf(20), Integer.valueOf(0), Integer.valueOf(100), v -> this.rainbow.getValue()));
    public Setting<Integer> rainbowSaturation = this.register(new Setting<>("Saturation", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.rainbow.getValue()));
    public Setting<Integer> rainbowBrightness = this.register(new Setting<>("Brightness", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.rainbow.getValue()));
    ...
    private final Setting<Boolean> modeVer = this.register(new Setting<>("Version", Boolean.valueOf(false), v -> this.watermark.getValue() != WaterMark.NONE));
    ...
    private final Setting<Boolean> moduleColors = this.register(new Setting<>("ModuleColors", Boolean.valueOf(false), v -> this.arrayList.getValue()));
    public Setting<Integer> animationHorizontalTime = this.register(new Setting<>("AnimationHTime", Integer.valueOf(500), Integer.valueOf(1), Integer.valueOf(1000), v -> this.arrayList.getValue()));
    public Setting<Integer> animationVerticalTime = this.register(new Setting<>("AnimationVTime", Integer.valueOf(50), Integer.valueOf(1), Integer.valueOf(500), v -> this.arrayList.getValue()));
    private final Setting<Boolean> alphabeticalSorting = this.register(new Setting<>("AlphabeticalSorting", Boolean.valueOf(false), v -> this.arrayList.getValue()));
    ...
    private final Setting<Boolean> altPotionsColors = this.register(new Setting<>("AltPotionColors", Boolean.valueOf(false), v -> this.potions.getValue()));
    ...
    private final Setting<Boolean> percent = this.register(new Setting<>("Percent", Boolean.valueOf(true), v -> this.armor.getValue()));
    ...
    private final Setting<String> spoofGreeter = this.register(new Setting<>("GreeterName", "3arthqu4ke", v -> this.greeter.getValue() == Greeter.CUSTOM));
    ...
    private final Setting<Sound> sound = this.register(new Setting<>("Sound", Sound.NONE, v -> this.hitMarkers.getValue()));
    public Setting<Integer> hudRed = this.register(new Setting<>("Red", Integer.valueOf(255), Integer.valueOf(0), Integer.valueOf(255), v -> this.rainbow.getValue() == false));
    public Setting<Integer> hudGreen = this.register(new Setting<>("Green", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.rainbow.getValue() == false));
    public Setting<Integer> hudBlue = this.register(new Setting<>("Blue", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(255), v -> this.rainbow.getValue() == false));
    private final Setting<Boolean> grayNess = this.register(new Setting<Boolean>("FutureColour", true));
    public Setting<Boolean> potions1 = this.register(new Setting<>("LevelPotions", Boolean.valueOf(false), v -> this.potions.getValue()));
    public Setting<Boolean> MS = this.register(new Setting<>("ms", Boolean.valueOf(false), v -> this.ping.getValue()));
    ...
    public void onUpdate() {
        for (Module module : Fobose.moduleManager.sortedModules) {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        switch (this.watermark.getValue()) {
            case FOBOSEPLUSTWO: {
                this.renderer.drawString("Fobose+2 " + (this.modeVer.getValue() != false ? Fobose.MODVER : ""), 2.0f, 2.0f, this.rolling.getValue() != false && this.rainbow.getValue() != false ? this.colorMap.get(2) : this.color, true);
                break;
            }
            case AESTHETICAL: {
                this.renderer.drawString("aesthetical.xyz " + (this.modeVer.getValue() != false ? Fobose.MODVER: ""), 2.0f, 2.0f, this.rolling.getValue() != false && this.rainbow.getValue() != false ? this.colorMap.get(2) : this.color, true);
                break;
            }
            case CUSTOM: {
                this.renderer.drawString(this.customWatermark.getValue() + (this.modeVer.getValue() != false ? (" " + Fobose.MODVER) : ""), 2.0f, 2.0f, this.rolling.getValue() != false && this.rainbow.getValue() != false ? this.colorMap.get(2) : this.color, true);
                break;
            }
        }
        ...
        if (this.arrayList.getValue().booleanValue()) {
            ...
            if (this.renderingUp.getValue().booleanValue()) {
                for (i = 0; i < (this.alphabeticalSorting.getValue() != false ? Fobose.moduleManager.alphabeticallySortedModules.size() : Fobose.moduleManager.sortedModules.size()); ++i) {
                    module = this.alphabeticalSorting.getValue() != false ? Fobose.moduleManager.alphabeticallySortedModules.get(i) : Fobose.moduleManager.sortedModules.get(i);
                    text3 = module.getDisplayName() + "\u00a77" + (module.getDisplayInfo() != null ? " [\u00a7f" + module.getDisplayInfo() + "\u00a77" + "]" : "");
                    moduleColor = Fobose.moduleManager.moduleColorMap.get(module);
                ...
                for (i = 0; i < (this.alphabeticalSorting.getValue() != false ? Fobose.moduleManager.alphabeticallySortedModules.size() : Fobose.moduleManager.sortedModules.size()); ++i) {
                    module = this.alphabeticalSorting.getValue() != false ? Fobose.moduleManager.alphabeticallySortedModules.get(Fobose.moduleManager.alphabeticallySortedModules.size() - 1 - i) : Fobose.moduleManager.sortedModules.get(i);
                    text3 = module.getDisplayName() + "\u00a77" + (module.getDisplayInfo() != null ? " [\u00a7f" + module.getDisplayInfo() + "\u00a77" + "]" : "");
                    moduleColor = Fobose.moduleManager.moduleColorMap.get(module);
        ...
        if (this.renderingUp.getValue().booleanValue()) {
            ...
            if (this.serverBrand.getValue().booleanValue()) {
                text2 = grayString + "Server brand " + "\u00a7f" + Fobose.serverManager.getServerBrand();
            ...
            if (this.potions.getValue().booleanValue()) {
                for (PotionEffect effect : Fobose.potionManager.getOwnPotions()) {
                    text = this.altPotionsColors.getValue() != false ? Fobose.potionManager.getPotionString(effect) : Fobose.potionManager.getColoredPotionString(effect);
                    this.renderer.drawString(text, width - (this.renderer.getStringWidth(text) + 2), height - 2 - (i += 10), this.rolling.getValue() != false && this.rainbow.getValue() != false ? this.colorMap.get(height - i) : (this.altPotionsColors.getValue() != false ? this.potionColorMap.get(effect.getPotion()).getRGB() : this.color), true);
                }
            }
            if (this.speed.getValue().booleanValue()) {
                text2 = grayString + "Speed " + "\u00a7f" + Fobose.speedManager.getSpeedKpH() + " km/h";
                this.renderer.drawString((String)text2, width - (this.renderer.getStringWidth((String)text2) + 2), height - 2 - (i += 10), this.rolling.getValue() != false && this.rainbow.getValue() != false ? this.colorMap.get(height - i) : this.color, true);
            }
            ...
            if (this.tps.getValue().booleanValue()) {
                String text4 = grayString + "TPS " + "\u00a7f" + Fobose.serverManager.getTPS();
            ...
            fpsText = grayString + "FPS " + "\u00a7f" + Minecraft.getDebugFPS();
            text3 = grayString + "Ping " + "\u00a7f" + (ServerModule.getInstance().isConnected() ? ServerModule.getInstance().getServerPing() : (long) Fobose.serverManager.getPing()) + (this.MS.getValue() != false ? "ms" : "");
            ...
            if (this.potions.getValue().booleanValue()) {
                for (PotionEffect effect : Fobose.potionManager.getOwnPotions()) {
                    text = this.altPotionsColors.getValue() != false ? Fobose.potionManager.getPotionString(effect) : Fobose.potionManager.getColoredPotionString(effect);
                    this.renderer.drawString(text, width - (this.renderer.getStringWidth(text) + 2), 2 + i++ * 10, this.rolling.getValue() != false && this.rainbow.getValue() != false ? this.colorMap.get(2 + i * 10) : (this.altPotionsColors.getValue() != false ? this.potionColorMap.get(effect.getPotion()).getRGB() : this.color), true);
                }
            }
            if (this.speed.getValue().booleanValue()) {
                text2 = grayString + "Speed " + "\u00a7f" + Fobose.speedManager.getSpeedKpH() + " km/h";
            ...
            if (this.tps.getValue().booleanValue()) {
                String text5 = grayString + "TPS " + "\u00a7f" + Fobose.serverManager.getTPS();
            ...
            fpsText = grayString + "FPS " + "\u00a7f" + Minecraft.getDebugFPS();
            text3 = grayString + "Ping " + "\u00a7f" + Fobose.serverManager.getPing();
            if (this.renderer.getStringWidth(text3) > this.renderer.getStringWidth(fpsText)) {
                if (this.ping.getValue().booleanValue()) {
                    this.renderer.drawString(text3, width - (this.renderer.getStringWidth(text3) + 2), 2 + i++ * 10, this.rolling.getValue() != false && this.rainbow.getValue() != false ? this.colorMap.get(2 + i * 10) : this.color, true);
                }
        ...
        if (this.renderingUp.getValue().booleanValue()) {
            Fobose.notificationManager.handleNotifications(height - (i + 16));
        } else {
            Fobose.notificationManager.handleNotifications(height - (j + 16));
        }
        ...
        String text6 = (this.direction.getValue() != false ? Fobose.rotationManager.getDirection4D(false) + " " : "") + (this.coords.getValue() != false ? coordinates : "") + "";
    ...
    public void renderLag() {
        int width = this.renderer.scaledWidth;
        if (Fobose.serverManager.isServerNotResponding()) {
            String text = (this.lag.getValue() == LagNotify.GRAY ? "\u00a77" : "\u00a7c") + "Server not responding: " + MathUtil.round((float) Fobose.serverManager.serverRespondingTime() / 1000.0f, 1) + "s.";
