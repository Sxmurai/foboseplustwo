...
import me.fobose.client.features.modules.player.XCarry;
...
extends Module {
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int)((float)this.delay.getValue().intValue() * (this.tps.getValue() != false ? Fobose.serverManager.getTpsFactor() : 1.0f)))) {
            if (!this.taskList.isEmpty()) {
