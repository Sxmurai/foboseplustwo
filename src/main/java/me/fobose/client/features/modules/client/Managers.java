...
public class Managers extends Module {
    ...
    public Setting<String> command = this.register(new Setting<String>("Command", "FobosePlusTwo.us"));
    ...
    public Setting<Integer> betterFPS = this.register(new Setting<>("MaxFPS", Integer.valueOf(300), Integer.valueOf(30), Integer.valueOf(1000), v -> this.betterFrames.getValue()));
    ...
    public Setting<Integer> cpuFPS = this.register(new Setting<>("UnfocusedFPS", Integer.valueOf(60), Integer.valueOf(1), Integer.valueOf(60), v -> this.unfocusedCpu.getValue()));
    ...
    @Override
    public void onLoad() {
        Fobose.commandManager.setClientMessage(this.getCommandMessage());
    }
        ...
        if (event.getStage() == 2) {
            ...
            if (event.getSetting() != null && this.equals(event.getSetting().getFeature())) {
                if (event.getSetting().equals(this.holeThread)) {
                    Fobose.holeManager.settingChanged();
                }
                Fobose.commandManager.setClientMessage(this.getCommandMessage());
            }
        }
