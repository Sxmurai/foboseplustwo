...
public class Sprint extends Module {
    ...
    public final Setting<Boolean> stopOnNoHunger = this.register(new Setting<>("StopOnNoHunger", true));
    ...
    public void onUpdate() {
        if (mc.player.getFoodStats().getFoodLevel() <= 6 && stopOnNoHunger.getValue()) {
            return;
        }
