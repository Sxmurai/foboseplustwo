...
import me.fobose.client.mixin.mixins.render.entity.IEntityRenderer;
...
public class RenderUtil implements Util {
    ...
    public static void drawLine(double x, double y, double z, double x2, double y2, double z2, float width, float r, float g, float b, float a) {
        GlStateManager.disableTexture2D();
        GlStateManager.enableBlend();
        GlStateManager.disableAlpha();
        GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
        ...
        GL11.glLoadIdentity();
        ((IEntityRenderer) mc.entityRenderer).runOrientCamera(mc.getRenderPartialTicks());
...
//        tessellator.draw();
    ...
    public static void drawText(BlockPos pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(-((double) Fobose.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
        Fobose.textManager.drawStringWithShadow(text, 0.0f, 0.0f, -5592406);
        GlStateManager.popMatrix();
    }
    ...
    public static void drawSphere(double x, double y, double z, float size, int slices, int stacks) {
        ...
        GL11.glTranslated(x - mc.getRenderManager().viewerPosX, y - mc.getRenderManager().viewerPosX, z - mc.getRenderManager().viewerPosZ);
