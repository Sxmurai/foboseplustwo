...
implements Util {
    ...
    public static void rightClickBlock(BlockPos pos, Vec3d vec, EnumHand hand, EnumFacing direction, boolean packet) {
        ...
        ((IMinecraft) BlockUtil.mc).setRightClickDelayTimer(4);
    }
    ...
    public static boolean placeBlockSmartRotate(BlockPos pos, EnumHand hand, boolean rotate, boolean packet, boolean isSneaking) {
        ...
        if (rotate) {
            Fobose.rotationManager.lookAtVec3d(hitVec);
        }
        BlockUtil.rightClickBlock(neighbour, hitVec, hand, opposite, packet);
        BlockUtil.mc.player.swingArm(EnumHand.MAIN_HAND);
        ((IMinecraft) BlockUtil.mc).setRightClickDelayTimer(4);
    ...
    public static void placeCrystal(BlockPos pos, EnumHand hand, boolean swing, boolean packet) {
        ...
        if (packet) {
            ...
            mc.playerController.processRightClickBlock(
                    ...
                    mc.world, pos,
                    facing,
                    result == null || result.hitVec == null ?
                            new Vec3d(pos).add(new Vec3d(facing.getDirectionVec())).scale(0.5) :
                            result.hitVec,
                    hand
            );
        }
